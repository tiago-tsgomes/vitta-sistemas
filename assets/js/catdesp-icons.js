// Ícones das categorias de despesa (traçado 24x24, estilo Feather/Lucide).
// A chave é o que fica salvo em CATDESP.ICONE_CATDESP. Compartilhado entre categorias-despesa.html e despesas.html.
window.CATDESP_ICONS = {
...
window.iconSvg = function iconSvg(key, cls, color) {
  return `<svg xmlns="http://www.w3.org/2000/svg" class="${cls}" fill="none" viewBox="0 0 24 24" stroke="${color || 'currentColor'}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${CATDESP_ICONS[key] || CATDESP_ICONS.more}</svg>`;
}
