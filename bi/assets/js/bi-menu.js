      ...
      <div style="width:100%;flex-shrink:0;">
        <div style="height:64px;background:#FFFFFF;border-bottom:1px solid #F1F0F5;display:flex;align-items:center;justify-content:space-between;padding:0 28px;">
          <div style="display:flex;align-items:center;gap:12px;">
            ...
            <div style="font-size:11.5px;font-weight:700;letter-spacing:.04em;color:#6D5DF6;background:#F3F1FE;padding:3px 8px;border-radius:6px;">BI</div>
          ...
          <div style="display:flex;align-items:center;gap:16px;">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
              <div style="width:34px;height:34px;border-radius:50%;background:#EEECFE;display:flex;align-items:center;justify-content:center;color:#6D5DF6;font-size:14.5px;font-weight:600;">${avatarLetter}</div>
              <div>
                <div style="font-size:14.5px;font-weight:600;color:#111827;line-height:1.2;">${userName}</div>
